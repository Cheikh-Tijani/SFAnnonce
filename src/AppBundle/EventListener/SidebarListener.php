...
class SidebarListener
{
    ...
    protected function getMenu(Request $request)
    {
        ...
        $rootItems = array(
            ...
            $admin = new MenuItemModel('Administration', 'Administration', 'homepage', $earg, 'fa fa-th', 'new'),
            $ui = new MenuItemModel('ui-elements', 'UI Elements', '', $earg, 'fa fa-laptop')
        );

        $admin->addChild(new MenuItemModel('ui-elements-general', 'General', 'avanzu_admin_ui_gen_demo', $earg))
